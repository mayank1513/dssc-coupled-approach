function [rt_TE,rt_TM]=Trf2(wavelen,Thita_i,n,d,repeatingSets)
...
[rt_TE(1,2),rt_TE(2,2),rt_TM(1,2),rt_TM(2,2)]=Trf(wavelen,Thita_i,n(end:-1:1),d(end:-1:1),repeatingSets_rev);
[rt_TE(1,1),rt_TE(2,1),rt_TM(1,1),rt_TM(2,1)]=Trf(wavelen,Thita_i,n,d,repeatingSets);
%figure();
%plot(ETrf_TE)
end

function [R_TE,T_TE,R_TM,T_TM]=Trf(wavelen,Thita_i,n,d,repeatingSets)
